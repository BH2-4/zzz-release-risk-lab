...
| **Observed runtime** | Focused suite 1.7s; full Node suite 3.5s; host E2E 10.1s, excluding dependency restoration and sandbox checkpoint wait |
...
| Focused Theory + compile | Exit 0; 39 tests passed, 0 failed, 0 skipped. |
...
| `npm test` | Exit 0; 146 passed, 0 failed, 0 skipped. |
| `npm run test:e2e` | Exit 0 on the Mac host; 10 passed and 4 explicit desktop/mobile project-matrix skips in 10.1s. The earlier sandbox-only bind denial is not counted as a pass or waiver. |
| Diff and secret scan | Exit 0; no whitespace defect and no filename hit in the bounded executable/data/generated scan. |
| Claim and ASVS L2 review | Green; fixture/non-live, synthetic-group, scenario-index, cooperative-writer, and same-UID residual-risk boundaries remain explicit; no unresolved HIGH-or-above finding. |
